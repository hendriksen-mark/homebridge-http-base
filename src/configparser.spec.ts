...
describe('Config Parser', () => {
  describe('URL parser', () => {
    it('should parse simple string url', () => {
    ...
    it('should reject array passed to #parseUrlProperty', () => {
      const url = ['https://localhost:8080'];
      expect(() => configParser.parseUrlProperty(url)).toThrow('property cannot be an array!');
    });

    it('should parse simple array of urls', () => {
    ...
    it('should reject illegal data type in array', () => {
    ...
    it('should parse simple urlObject', () => {
      const configObject = {
    ...
    it('should parse simple array of urlObjects', () => {
      const configObjects = [
        {
          url: 'https://localhost:8080',
        },
    ...
    it('should parse maxed out urlObject', () => {
      const object = {
        url: 'https://localhost:8080',
        method: 'POST',
        body: 'foo',
    ...
    it('should accept object as body property', () => {
      const object = {
    ...
    it('should properly convert key-value objects passed to headers', () => {
      const object = {
        url: 'https://google.com',
        headers: [
          {
  ...
  describe('MQTT parser', () => {
    it('should parse maxed out mqtt options object', () => {
      const mqttObject = {
        host: 'localhost',
        port: 1234,
        protocol: 'smqtt',
    ...
    it('should parse simple get topic', () => {
    ...
    it('should reject array passed to #parseMQTTSetTopicProperty', () => {
    ...
    it('should parse simple set topic object', () => {

    });
    it('should parse simply array of set topic objects', () => {

    });
    it('should parse maxed out set topic object', () => {
